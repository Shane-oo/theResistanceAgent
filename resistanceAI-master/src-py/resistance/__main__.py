...
resistanceWins = 0
spyWins = 0
# main function for collecting validation of bayesAgents
for i in range(100):
        agents = [trainingAgent(name='r1'), 
                trainingAgent(name='r2'), 
                trainingAgent(name='r3'), 
                trainingAgent(name='r4'), 
                trainingAgent(name='r5')
                ]
        ...
        if(whoWonValue == True):
                ...
                spyWins+=1
        index = 0
        # Just finding the missing data for the 'myAgent' array
        for findNoData in resistanceData[0]:
                if findNoData[0] == 'MyAgent':
                        ...
                        for agents in resistanceData[1]:
                                ...
                                count +=1
                index+=1        
        # Setting the is_Spy to 1 for the spies
